      ...
      <div className="p-4">
        ...
        <div className="mt-2">
          <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${
            post.category === 'cachorros' ? 'bg-blue-100 text-blue-800' :
            post.category === 'gatos' ? 'bg-orange-100 text-orange-800' :
            post.category === 'outros' ? 'bg-gray-100 text-gray-800' :
              ...
              <div>
                ...
                {myPosts.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">Você ainda não publicou nenhuma adoção</p>
                    <button
                      onClick={() => navigate('/posts')}
                      className="mt-4 bg-purple-500 text-white px-6 py-2 rounded-md hover:bg-purple-600"
                    >
